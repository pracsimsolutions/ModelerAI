---
id: reference_peopleobjects_3dobjects_prop_prop
name: "Prop"
kind: manual
breadcrumb: ["Reference","PeopleObjects","3DObjects","Prop","Prop"]
tags: ["manual","reference","peopleobjects","3dobjects"]
source: "manual/Reference/PeopleObjects/3DObjects/Prop/Prop.html"
---
...
The Prop object represents objects, such as doors, desks, tables, rooms and other shapes, that person flowitems and staff can occupy and interact with. Like Location objects, it defines the behavior of people who arrive at and leave them.
...
The Prop uses the same statistics as a fixed resource. See Fixed Resource Concepts - Statistics for an explanation of these statistics.
...
The Prop object uses the following properties panels:
