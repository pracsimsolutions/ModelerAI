---
id: reference_propertiespanels_generalpanels_labels_labels
name: "Labels"
kind: manual
breadcrumb: ["Reference","PropertiesPanels","GeneralPanels","Labels","Labels"]
tags: ["manual","reference","propertiespanels","generalpanels"]
source: "manual/Reference/PropertiesPanels/GeneralPanels/Labels/Labels.html"
---

# Labels

The Labels panel lists the object's labels.

 

 

Labels are custom variables that you can specify on the object. For example, if you want to keep track of the number of flow items of itemtype 3 that have entered an object, you can use a label to keep a record of this value. For information on using labels, see the [Label Properties](../../../CodingInFlexSim/FlexScriptAPIReference/FlexScriptClassReference.html?Class=treenode&Property=labelProperties) documentation.
