---
id: postwindowmessage
name: "postwindowmessage"
kind: command
module: ""
signature: "postwindowmessage(HWND window, num msg[, num/str/node wParam, num/str/node lParam])"
aliases: []
tags: ["command", "group-development"]
deprecated: false
replacedBy: "windowfromnode"
description: "FlexScript command: postwindowmessage."
seeAlso: []
